...
def random_phrase():
    phrases = ['I\'m dead inside',
               'Honesty lets take a minute and appreciate how good looking Ahad is. Mr. Consistent more like Mr. consistenly foiinnnneee',
               'George Bush doesnt care about black people.',
               'Good luck, I guess',
               'Somettimes I get emotional over fonts',
               'If i had a dollar for every championship Mitchell has won I would still be broke',
               'I miss pat :(',
               'I miss the old commish, at least he was handsome',
               'Collin dyes his hair red for attention',
               'Did the new guy even go to FHS?',
               'Mitchell please fix your face, also your team',
               'Sigh... lets get this money',
               'I could dunk on Justin but his bitch ass wont play me 1v1',
               'How would I describe myself? Three words: hard working, alpha male, jackhammer,merciless,insatiable' ,
               'Sometimes I push the door close button on people running towards the elevator. I need my own elevator sometimes'
